...
const posts = [
  ...
  },
  {
    ...
    body: 'I recently tried skydiving for the first time, and it was an exhilarating experience! The adrenaline rush of jumping out of a plane and the breathtaking views of the landscape below made it an unforgettable adventure. I can’t wait to try more extreme sports in the future!',
    likes: 7,
    dislikes: 3,
    user_id: 15,
  },
  {
    ...
    body: 'Music has the power to uplift the soul and bring people together. I recently attended a concert by my favorite band, and the energy of the crowd was electrifying. As the music played, I felt a deep connection with the people around me. It was a truly unforgettable experience.',
    likes: 5,
    dislikes: 1,
    user_id: 14,
  },
  {
    ...
    body: 'I recently volunteered at a local soup kitchen, and it was a humbling experience. Seeing the smiles on people’s faces as they enjoyed a warm meal reminded me of the importance of giving back to the community. It’s a simple act of kindness that can make a big difference in someone’s life.',
    likes: 2,
    dislikes: 0,
    user_id: 13,
  },
  ...
  {
    title: 'Marvels of Underwater Life',
    body: 'The underwater world is a fascinating place. I recently went scuba diving and was amazed by the vibrant coral reefs and colorful fish. It was a humbling experience that reminded me of the importance of protecting our oceans.',
    likes: 2,
    dislikes: 0,
    user_id: 9,
  },
